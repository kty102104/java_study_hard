...
public class Person {
    ...
    public void setName(String name) {
        ...
        // 막을 수도 있음.
        if (name.length() > 4) {
            System.out.println("이름이 글자 수를 초과했습니다.");
    ...
    // setAge() - 매개변수 1개와 / setInfo() - 매개변수 2개 를 정의하시오.

    public void setAge(int age) {
        // 0 미만 또는 200 초과의 값이 입력됐을 경우에는 "불가능한 나이 입력입니다." 출력
    ...
    // 데이터를 조회만 하면 되기 때문에 매개변수가 요구되지 않음. 즉 () 안에 아무것도 없다.
    // 필드와 동일한 자료형의 return값이 요구되기 때문에 -> void가 아니다.
    public String getName() {
        return name;
    }

    // getAge()를 정의하시고, PersonMain에서 person01 객체의 나이를 조회하여
    // "저는 올해 --살입니다. 내년에는 --+1살이 됩니다."가 출력되도록
    // Person / PersonMain을 작성하시오.
    public int getAge() {
        return age;
    }
