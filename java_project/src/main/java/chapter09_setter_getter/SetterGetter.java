...
/*
    1. Setter / Getter의 필요성
        ...
        이름(name), 나이(age) 등의 정보를 저장하기 위해서 필드를 선언합니다.
        ...
        그리고 이를 PersonMain에서 객체를 생성했다고 가정해보겠습니다.
        ...
        해당 코드를 확인했을 때 나이에 정상적이지 않은 값이 입력돼 있습니다.
        ...
        2. Setter / Getter란?
            ...
            수정하지 못하도록 막고, 특정 메서드를 통해 값을 전달받아 초기화 및 수정
        ...
        4. 그래서 Setter / Getter가 언제나 필수적인가?
            ...
            이는 객체 지향 프로그래밍에서 중요한 기초이며, 클린 코드를 작성하는 과정이라는 측면에서도
            중요한 개념입니다.
 */
