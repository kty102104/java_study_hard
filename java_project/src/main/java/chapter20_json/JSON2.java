...
public class JSON2 {
    public static void main(String[] args) {
        ...
        // 이상의 방법은 좀 간접적이고 직접적으로 알아보기 위한 방식으로는 instanceof를 사용할 수 있습니다.
        ...
        // 이상까지의 코드들은 보니까 User라는 클래스를 정의해놓고 거기에 멤버 변수에 값을 대입해서
        // JSON 데이터로 바꾼 듯 보입니다.

        // 그렇다면 JsonObject는 뭐였을까요?
        // 클래스를 따로 정의하지 않아도 JSON 데이터를 생성할 수 있게 해주는 역할
