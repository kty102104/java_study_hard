    ...
    1. 빌더 패턴(Builder Pattern)이란?
        ...
        주요 특징 :
            ...
            2) 불필요한 생성자 오버로딩을 줄여 가독성을 높임(기본생성자/필드1만 포함하는 생성자/
                필드2만 포함하는 매개변수 생성자/필드 1,2를 다 포함하는 매개변수 생성자)
...
//    }
    ...
    // name, age, address를 Person 객체의 인스턴스 변수 name, age, address에 대입하는 구조
    ...
    public static class Builder {
        ...
        // 여기서는 Person의 필드 명과 동일하게 작성할 예정입니다.
