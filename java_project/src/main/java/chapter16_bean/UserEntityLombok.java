...
/*
    ctrl + alt + s / 상단에 메뉴바(햄버거) file - settings 들어갑니다

    Lombok 설치 과정
    좌측 부분 스크콜링해서 하단으로 내려가면 plugin에서 lombok ->
    설치 -> enabled되게끔 합니다 (disabled가 보이면 현재 활성화상태)

    chrome mvn 검색 Maven Repository가 나오게 되는데
