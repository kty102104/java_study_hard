...
//        age = 38;       // 초기화 -> 처음으로 변수에 데이터가 대입되는 것을 의미
        ...
        /*
            Java에서의 변수 표기 방식 :
             카멜 표기법(Camel case) : 첫 문자는 소문자로 쓰고, 복수의 단어가 연결된 경우네는
...
//        checkFlag4 = false; // 초기화
    /*
        최초로 변수를 선언할 대 자료형(data type)을 명시하고 값을 대입하여 초기화 함.
        추후 해당 변수에 값을 재대입하는 경우 변수명 = (바뀐)값; 형태로 작성함.
     */
        // 2. 문자 자료형 변수
//        char name1 = '안';       // 문자를 입력할 때는 작은 따옴표(')로 감싼다.
//        char name2 = '근';       // char은 character의 축약어. 알파벳 / 한글 / 숫자 하나를 의미
//        char name3 = '수';       // 문자 =/= 문자열
...
//        System.out.println("" + name1 + name2 + name3);  // 안근수
        /*
            ...
            지정을 해줘야 한다는 점입니다.
            문자와 문자열은 서로 다른데 문자(하나짜리)를 세 번 더했을 경우 더 이상 문자가 아니라
            문자열로 되어야 합니다.
...
//        System.out.println("제 이름은 " + name + "입니다. 제 나이는 " + (age + 1) + "살입니다.");
        ...
        /*
            원래 Java 17 이전까지는 String에 한 줄 씩만 작성이 가능했습니다.
