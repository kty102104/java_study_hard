...
/*
    컬렉션(Colelction)은 여러 객체를 모아놓은 것을 의미함.
    종류 :
...
//        System.out.println(searchElem + " 포함 여부 : " + contains);
        ...
        // 하는 것이기 때문에 element의 일부인 문자열로는 포함 여부 확인이 불가능합니다.

        // 특정 element 삭제 -> .remove()
        String removeElem = "C#";
        boolean removed = strList.remove(removeElem);
        // remove() 메서드 : 삭제 여부를 반환함
        ...
        Collections.sort(strList);  // 배열과 유사하게 원본의 정렬을 바꿉니다 -> 변수 대입할 필요 x
