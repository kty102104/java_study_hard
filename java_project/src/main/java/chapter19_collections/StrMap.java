...
public class StrMap {
    public static void main(String[] args) {
        ...
        // 특정 키의 값 수정 #1 -> .put()을 통해 덮어쓰기 -> Map의 성격
        ...
        // Key Set 출력 -> 제네릭의 첫 번째 매개변수인 key에 해당하는 자료형을 넣어야 함.
        Set<String> keySet = strMap.keySet();
        System.out.println(keySet);

        // Value Set 출력 -> 제네릭의 두 번째 매개변수인 value에 해당하는 자료형을 넣어야 함.
        Collection<String> values = strMap.values();    // key는 중복이 불가능하기 때문에
                                                        // Set을 쓰는데, value는 중복되어
        // 있을 수 있으므로 Set을 쓰게 되면 중복 제거가 될 확률이 있어 Collection을 사용함.(Collections 아님)
