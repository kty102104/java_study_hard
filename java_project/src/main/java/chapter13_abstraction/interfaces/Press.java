...
public interface Press {
    ...
    // 초기화까지 이루어져야 합니다.(final이기 때문)

    // 안되는 것들 예시
//    private String name;    // 접근제어자 지정 불가능 -> 선언만 하는 것도 불가능
...
//    }
    ...
    // default했더니 구현부 있는 일반 메서드가 되는 것처럼 나온 부분 -> Java8에서
    // 업데이트 된 내용이고. default의 경우 동일 패키지 내에서는 사용가능 했었음.
